...
def init_kaggle_dataset():
    print("🚀 Synchronizing Kaggle Dataset for Realization Engine...")
    ...
    try:
        subprocess.run(["kaggle", "datasets", "version", "-p", staging_dir, "-m", "Sync with core directory", "--dir-mode", "zip"], check=True)
